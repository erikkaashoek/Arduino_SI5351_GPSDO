...
extern String ToString(uint64_t x);
#define DEBUG(X)  Serial.print(X)
#define DEBUGLN64(X)  { String str;str = ToString(X); Serial.println(str);}
#define DEBUG64(X)  { String str;str = ToString(X); Serial.print(str);}
...
DEBUG(" pll_freq="); DEBUGLN64(pll_freq);
			// Set PLL
...
DEBUG(" ref_freq="); DEBUG64(ref_freq);
...
DEBUG(" abc=");DEBUG(a);DEBUG(",");DEBUG(b);DEBUG(",");DEBUGLN(c);
...
DEBUG(" pll_freq="); DEBUG64(pll_freq);
	// Calculate parameters
	if (divby4 == 1)
	{
		p3 = 1;
